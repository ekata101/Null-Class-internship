...
function showMessage(text, type = "success", elementId = "msg") {
  ...
  msg.innerText = text;
  setTimeout(() => { if (msg.innerText === text) msg.className = "msg"; }, 5000);
}
...
function checkPasswordStrength() {
  ...
  if (strength <= 2) {
    ...
    bar.style.width = "60%"; bar.style.background = "#f97316";
    text.innerText = "Medium strength"; text.style.color = "#f97316";
  } else {
    bar.style.width = "100%"; bar.style.background = "#22c55e";
    text.innerText = "Strong password"; text.style.color = "#22c55e";
  }
}
